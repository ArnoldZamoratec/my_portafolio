...
const SERVICES_EN = [
  { name: "Python (FastAPI) & Java" },
  { name: "Node.js & PHP Backend" },
  { name: "Data Science & ML" },
  { name: "Databases (MySQL, Firebase)" },
  { name: "Prompt Engineering & Obsidian" },
] as const satisfies { name: string }[];

const SERVICES_ES = [
  { name: "Backend con Python y Java" },
  { name: "Node.js y PHP" },
  { name: "Data Science y ML" },
  { name: "Bases de Datos (MySQL, Firebase)" },
  { name: "Prompt Engineering y Obsidian" },
] as const satisfies { name: string }[];
